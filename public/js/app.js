...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_2__);
 // calling from node modules folder

 // calling Noty from Node mosules folder Noty
...
function initAdmin() {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().get("/admin/orders", {
    ...
    console.log("ORDER FETCHING FOR ADMIN ERRRORS COMES IS", err);
  });
...
var cartCounter = document.getElementById("cartCounter"); // cart mein update krne wala product aur session mein cart ko store krne k liye yhn p hm axios libraray use krenge
...
var updateCart = function updateCart(product) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/update-cart", product).then(function (res) {
    ...
    cartCounter.innerText = res.data.totalQty; // message show kr rhe h

    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      type: "success",
      timeout: 1200,
      //after this milisecond it hide
      text: "Item Added to Cart!",
      progressBar: false // layout: "bottomRight",
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    ...
    var product = JSON.parse(btn.dataset.product); // server p request bhejen k function h update cart or apne cart ko store krwayenge session mein

    updateCart(product); // console.log(product);
  });
...
(0,_admin__WEBPACK_IMPORTED_MODULE_2__.initAdmin)(); // Slidehow js
...
(function () {
  var productContainer = document.querySelector(".product-filter");
  var productItems = document.querySelectorAll(".product-item");
  productContainer.addEventListener("click", function (event) {
    if (event.target.classList.contains("filter-item") && !event.target.classList.contains("active")) {
      // DEACTIVATE EXISTING ACTIVE 'filter-item'
      productContainer.querySelector(".active").classList.remove("outer-shadow", "active"); // ACTIVATING NEW FILTER ITEM

      event.target.classList.add("active", "outer-shadow"); // Getting attribute here after clicking

      var target = event.target.getAttribute("data-target"); // console.log(target);
...
var modal13 = document.getElementById("myModal13"); // Get the button that opens the modal
...
var btn13 = document.getElementById("myModalBtn13"); // Get the <span> element that closes the modal

var cls1 = document.querySelector("#close-1"); // console.log(cls1);
...
var cls13 = document.querySelector("#close-13"); // When the user clicks on the button, open the modal
...
cls4.addEventListener("click", function () {
  modal4.style.display = "none";
});
cls5.addEventListener("click", function () {
  modal5.style.display = "none";
});
cls6.addEventListener("click", function () {
  modal6.style.display = "none";
});
cls7.addEventListener("click", function () {
  modal7.style.display = "none";
});
cls8.addEventListener("click", function () {
  modal8.style.display = "none";
});
cls9.addEventListener("click", function () {
  modal9.style.display = "none";
});
cls10.addEventListener("click", function () {
  modal10.style.display = "none";
});
cls11.addEventListener("click", function () {
  modal11.style.display = "none";
});
cls12.addEventListener("click", function () {
  modal12.style.display = "none";
});
cls13.addEventListener("click", function () {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtimeproductapp"] = self["webpackChunkrealtimeproductapp"] || [];
